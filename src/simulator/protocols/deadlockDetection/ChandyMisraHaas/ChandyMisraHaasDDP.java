...
public class ChandyMisraHaasDDP extends DeadlockDetectionProtocol {
    ...
    protected void detectDeadlock() {
        if(Log.isLoggingEnabled()) log.log("Detecting Deadlock");
        ...
        if(Log.isLoggingEnabled()) log.log("Detecting Deadlock starting from " + numStart + " locks.");
    ...
    public void receiveMessage(Message msg) {
        ...
        if( msg.getObject() instanceof ProbeMessage ){
            ...
            if( probeMessage.getRecipient() == probeMessage.getInitiator() ){
                ...
                if(Log.isLoggingEnabled()) log.log(probeMessage.getInitiator(),"Probe has reached "+probeMessage.getRecipient());
