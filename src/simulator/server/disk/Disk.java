...
public class Disk {
    ...
    public void receiveMessage(Message message) {
        ...
        addJob(new DiskJob(transID,deadline,pageNum,pNum -> {
            if(Log.isLoggingEnabled()) log.log(transID,"Write job completed: page " + pageNum);
            //Do nothing when the write job finishes. fk it
        }));
    }
    ...
    public void abort(int transNum) {
        if(Log.isLoggingEnabled()) log.log(transNum,"Clearing disk jobs");
